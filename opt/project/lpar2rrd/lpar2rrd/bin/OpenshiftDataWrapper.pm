# OpenshiftDataWrapper.pm
# interface for accessing Openshift data:

package OpenshiftDataWrapper;
...
require OpenshiftDataWrapperJSON;

#use OpenshiftDataWrapperSQLite;
...
if ( defined $ENV{XORMON} && $ENV{XORMON} ) {
  ...
  sub isGranted {
    my $uuid = shift;
    return $acl->isGranted( { hw_type => 'OPENSHIFT', item_id => $uuid, match => 'granted' } );
  }
}
...
sub get_items {
  ...
  $result = OpenshiftDataWrapperJSON::get_items( \%params );

  return $result;
}

sub get_conf {
  my $result = OpenshiftDataWrapperJSON::get_conf(@_);
  return $result;
}

sub get_conf_label {
  my $result = OpenshiftDataWrapperJSON::get_conf_label(@_);
  return $result;
}

sub get_conf_architecture {
  my $result = OpenshiftDataWrapperJSON::get_conf_architecture(@_);
  return $result;
}

sub get_conf_section {
  my $result = OpenshiftDataWrapperJSON::get_conf_section(@_);
  return $result;
}
...
sub get_label {
  ...
  if ( exists $self->{labels} ) {
    ...
    $result = OpenshiftDataWrapperJSON::get_label(@_);
  }
  return $result;
}

sub get_pod {
  my $result = OpenshiftDataWrapperJSON::get_pod(@_);

  return $result;
}

sub get_top {
  my $result = OpenshiftDataWrapperJSON::get_top();

  return $result;
}

sub get_all_containers {
  my $result = OpenshiftDataWrapperJSON::get_all_containers();

  return $result;
}

sub get_pods {
  my $result = OpenshiftDataWrapperJSON::get_pods();

  return $result;
}

sub get_service {
  my $result = OpenshiftDataWrapperJSON::get_service(@_);

  return $result;
}

sub get_conf_update_time {
  my $result = OpenshiftDataWrapperJSON::get_conf_update_time(@_);
  return $result;
}
