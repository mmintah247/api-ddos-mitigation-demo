...
VIMRuntime::make_get_set('ClusterComputeResource', 'configuration', 'recommendation', 'drsRecommendation', 'summaryEx', 'hciConfig', 'migrationHistory', 'actionHistory', 'drsFault');
...
our @property_list = (
   ...
   ['summaryEx', 'ClusterComputeResourceSummary', undef],
...
sub HttpNfcLeaseProbeUrls {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('HttpNfcLeaseProbeUrls', %args));
   return $response
}
...
sub QueryConnections {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('QueryConnections', %args));
   return $response
}

sub DropConnections {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DropConnections', %args));
   return $response
}
...
sub HostDeleteVStorageObjectEx_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('HostDeleteVStorageObjectEx_Task', %args));
   return $response
}

sub HostDeleteVStorageObjectEx {
   my ($self, %args) = @_;
   return $self->waitForTask($self->HostDeleteVStorageObjectEx_Task(%args));
}

sub HostUpdateVStorageObjectMetadataEx_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('HostUpdateVStorageObjectMetadataEx_Task', %args));
   return $response
}

sub HostUpdateVStorageObjectMetadataEx {
   my ($self, %args) = @_;
   return $self->waitForTask($self->HostUpdateVStorageObjectMetadataEx_Task(%args));
}
...
sub DeleteVStorageObjectEx_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DeleteVStorageObjectEx_Task', %args));
   return $response
}

sub DeleteVStorageObjectEx {
   my ($self, %args) = @_;
   return $self->waitForTask($self->DeleteVStorageObjectEx_Task(%args));
}

sub VCenterUpdateVStorageObjectMetadataEx_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('VCenterUpdateVStorageObjectMetadataEx_Task', %args));
   return $response
}

sub VCenterUpdateVStorageObjectMetadataEx {
   my ($self, %args) = @_;
   return $self->waitForTask($self->VCenterUpdateVStorageObjectMetadataEx_Task(%args));
}
